            ...
            <div class="py-6 px-4 sm:p-6 lg:pb-8">
              ...
              <div class="mt-6 grid grid-cols-12 gap-6">
                ...
                <div class="col-span-12 sm:col-span-6">
                  ...
                  <input type="text" name="numriTel" value="{{Auth::user()->numriTel ? Auth::user()->numriTel : '0'}}" id="last-name" autocomplete="family-name" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-sky-500 focus:border-sky-500 sm:text-sm">
                </div>
                ...
                <div class="col-span-12 sm:col-span-6">
                  ...
                  <input type="text" name="rruga" value="{{Auth::user()->rruga ? Auth::user()->rruga : 'null' }}" id="company" autocomplete="organization" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-sky-500 focus:border-sky-500 sm:text-sm">
                </div>
              </div>
            </div>
