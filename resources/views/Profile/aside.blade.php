<aside class="py-6 lg:col-span-3">
    <nav class="space-y-1">
        <a href="{{ route('user.index') }}"
            class="border-transparent text-gray-900 hover:text-[#ff5e63] group border-l-4 px-3 py-2 flex items-center text-sm font-medium"
            aria-current="page">

            <div class="flex">
                <div class="text-gray-400 group-hover:text-[#ff5e63] flex-shrink-0 -ml-1 mr-3 h-6 w-6">
