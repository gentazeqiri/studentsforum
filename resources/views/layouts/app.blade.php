...
<body>
  ...
  <nav class="bg-gray-700  px-2 sm:px-4 ">
    ...
    <a href="/home" class="flex items-center">
        <img src="{{asset('logo/logo.png')}}" class="mr-3 h-6 sm:h-9" alt="Flowbite Logo">
        <span class="self-center text-xl font-semibold whitespace-nowrap text-white">Student's Forum</span>
    </a>
